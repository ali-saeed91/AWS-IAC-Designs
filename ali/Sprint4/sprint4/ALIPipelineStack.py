...
from sprint4.ALIStage import ALIStage
...
class ALIPipelineStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        synth = pipelines_.CodeBuildStep("Synth",
                                     input = source,
                                     commands = ["cd ali/Sprint4",
                                                 "npm install -g aws-cdk",
                                                 "pip install -r requirements.txt",
                                                 "pip install -r requirements-dev.txt",
                                                 "cdk synth"],
                                     primary_output_directory = "ali/Sprint4/cdk.out"
                                     )
        # Create a pipeline
        # https://docs.aws.amazon.com/cdk/api/v2/python/aws_cdk.pipelines/README.html#cdk-pipelines
        pipeline = pipelines_.CodePipeline(self, "ALIPipelineSprint4", synth =synth)
