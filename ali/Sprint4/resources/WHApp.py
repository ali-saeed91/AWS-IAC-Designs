...
def lambda_handler(event, context):
    ...
    for i in URL:
        ...
        cloudwatch_object.cloudWatch_metric_alarm("Availability_of_ALI_" + str(i),
        ...
        cloudwatch_object.cloudWatch_metric_alarm("Latency_of_ALI_" + str(i),
        AlarmActions,constants.LatencyMetric,constants.nameSpace,dimensions,0.4,"GreaterThanThreshold")
