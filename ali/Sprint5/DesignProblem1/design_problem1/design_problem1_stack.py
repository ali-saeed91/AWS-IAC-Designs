...
class DesignProblem1Stack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        """  
            UPDATE:Sprint 5: Performing CloudWatch and Alarm Actions using Boto3 SDK
        """
        ...
        # """ Adding WH Lambda name to API Lambda for invocation """
        # apiLambda.add_environment('WHLambda',fn.function_arn)
    ...
    def create_urldynamoDB_table(self):
        table = db_.Table(self, "ARGTable",
            partition_key = db_.Attribute(name="arg1", type=db_.AttributeType.STRING),
            removal_policy = RemovalPolicy.DESTROY,
    )
        return table